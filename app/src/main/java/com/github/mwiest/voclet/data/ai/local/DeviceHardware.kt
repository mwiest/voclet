...
class DeviceHardware @Inject constructor(
    ...
    /** The tier recommended for this device. */
    fun suggestedTier(): ModelTier = suggestTierForRam(totalRamBytes())

    companion object {

        /**
         * Pure RAM → tier mapping: the largest model the device has the RAM
         * for, read off the catalog rather than restated here. Duplicating the
         ...
         */
        fun suggestTierForRam(totalRamBytes: Long): ModelTier =
            AiModel.ALL
