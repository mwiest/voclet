...
fun SettingsScreen(
            ...
            item {
                SettingsSection(title = stringResource(R.string.settings_about)) {
                    SettingsRow(
                        ...
                        summary = stringResource(R.string.app_version, BuildConfig.VERSION_NAME),
    ...
    if (showDeleteStatsDialog) {
        AlertDialog(
            ...
            confirmButton = {
                // Filled, not tinted text: this is the step that destroys
                // something, and it should not read as one more label to tap.
                Button(
                    onClick = {
